...
> **Next leaf to work: `2.d.iii.zo`** *(Phase 2 — Discovery & Trust, Legal & Compliance, SEO — `schema.org` `SoftwareApplication` structured data. Closes out `2.d.iii` and `2.d` (Legal & Compliance) in full. `5.f.i.zi` — provision Supabase — remains gated behind Phases 1–4 per existing ordering.)*
