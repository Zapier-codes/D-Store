...
> **Next leaf to work: `2.d.iii.zi`** *(Phase 2 — Discovery & Trust, Legal & Compliance, SEO — Per-app `sitemap.xml`. Closes out `2.d.ii`; next is `2.d.iii`, the last track in `2.d`. `5.f.i.zi` — provision Supabase — remains gated behind Phases 1–4 per existing ordering.)*
