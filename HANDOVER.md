...
> **Next leaf to work: `0.g.iii.zi`** *(Search & Category Browse — Related content: similar-apps rail (dummy), on the app detail page. Part of Phase 0, UI revamp priority, see Section 2. `5.f.i.zi` — provision Supabase — resumes once Phase 0 is complete.)*
