...
> **Next leaf to work: `2.d.ii.zo`** *(Phase 2 — Discovery & Trust, Legal & Compliance, Consent — DMCA/takedown process page, closing out `2.d.ii`. Same forward-reference pattern as the other legal pages: the footer's "DMCA" link (`0.c.iii.zi`), the Privacy Policy's (`2.d.i.zi`), and the Terms of Service's (`2.d.i.zo`) `/dmca` links all already point at it. `5.f.i.zi` — provision Supabase — remains gated behind Phases 1–4 per existing ordering.)*
