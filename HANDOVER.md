...
> **Next leaf to work: `0.g.iii.zo`** *(Search & Category Browse — Related content: developer profile page (dummy). Part of Phase 0, UI revamp priority, see Section 2. `5.f.i.zi` — provision Supabase — resumes once Phase 0 is complete.)*
