...
> **Next leaf to work: `0.g.ii.zo`** *(Search & Category Browse — Category browse: advanced filters (license, size) on the per-category page. Part of Phase 0, UI revamp priority, see Section 2. `5.f.i.zi` — provision Supabase — resumes once Phase 0 is complete.)*
