...
> **Next leaf to work: `1.a.ii.zo`** *(Phase 1 — Foundation, Data Model Migration, Trust & safety fields — Add `play_store_rejection_reason` field to the app entity, closing out `1.a.ii`. `5.f.i.zi` — provision Supabase — remains gated behind Phases 1–4 per existing ordering.)*
