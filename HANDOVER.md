...
> **Next leaf to work: `0.e.iii.zo`** *(App Detail Page — Ratings: anonymous rating submission — dummy, updates local state only, no backend. Part of Phase 0, UI revamp priority, see Section 2. `5.f.i.zi` — provision Supabase — resumes once Phase 0 is complete.)*
