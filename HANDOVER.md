...
> **Next leaf to work: `0.f.ii.zo`** *(App Detail Page — Transparency: permissions disclosure list, dummy data (`App.permissions`). Part of Phase 0, UI revamp priority, see Section 2. `5.f.i.zi` — provision Supabase — resumes once Phase 0 is complete.)*
