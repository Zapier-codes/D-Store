...
> **Next leaf to work: `0.f.iii.zi`** *(App Detail Page — Moderation: anonymous "Report app" form, dummy submit — logs locally, no backend. Part of Phase 0, UI revamp priority, see Section 2. `5.f.i.zi` — provision Supabase — resumes once Phase 0 is complete.)*
