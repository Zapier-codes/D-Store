...
> **Next leaf to work: `2.d.ii.zi`** *(Phase 2 — Discovery & Trust, Legal & Compliance, Consent — Cookie/ad consent banner. Closes out `2.d.i`; next is `2.d.ii`. `5.f.i.zi` — provision Supabase — remains gated behind Phases 1–4 per existing ordering.)*
