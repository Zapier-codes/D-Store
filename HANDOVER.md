...
> **Next leaf to work: `1.a.iii.zi`** *(Phase 1 — Foundation, Data Model Migration, New entities — Create `Review` entity (anonymous, rate-limited), starting `1.a.iii` now that `1.a.ii` is complete. `5.f.i.zi` — provision Supabase — remains gated behind Phases 1–4 per existing ordering.)*
